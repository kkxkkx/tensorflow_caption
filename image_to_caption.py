...
from caption.config import max_token_length, test_a_image_folder, best_model
from caption.forward import build_model
from caption.generated import test_gen
...
class Caption(object):
    ...
    def beam_search_predictions(self, model, image_name, word2idx, idx2word, encoding_test, beam_index=3):
        ...
        while len(start_word[0][0]) < max_token_length:
            temp = []
            for s in start_word:
                # 序列进行填充的预处理，在其后添0，使其序列统一大小为max_token_length
